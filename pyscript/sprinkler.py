...
from pyscript.modules.sprinkler.datetime_utils import aware_now
...
def apply_daily_balance_if_needed(zone_store, irrigation_store):
    ...
    for zone in zone_store.all().values():
        ...
        log_irrigation.info(f"Apply Soil (Old): {soil}, Capa: {capacity}, Optimal: {optimal}, New Soil: {new_soil}")
